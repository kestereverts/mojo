...
public class OutputThread extends Thread {
     ...
     *                 byte array.
     */
    static void sendRawLines(PircBot bot, BufferedWriter bwriter, String lines) {
        if(!lines.endsWith("\r\n")) {
            lines += "\r\n";
        }
        synchronized(bwriter) {
     ...
     *                 byte array.
     */
    static void sendRawLines(PircBot bot, BufferedWriter bwriter, String lines, String prefix) {
        String[] linesArraylines = lines.split("\r\n|\r|\n");
